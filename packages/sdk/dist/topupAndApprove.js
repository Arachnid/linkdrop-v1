...
var _ERC20Mock = _interopRequireDefault(require("../../contracts/build/ERC20Mock.json"));

var _ERC721Mock = _interopRequireDefault(require("../../contracts/build/ERC721Mock.json"));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            ...
            tokenContract = new _ethers.ethers.Contract(tokenAddress, _ERC20Mock["default"].abi, wallet);
            _context2.next = 16;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            nftContract = new _ethers.ethers.Contract(nftAddress, _ERC721Mock["default"].abi, wallet);
            _context3.next = 14;
