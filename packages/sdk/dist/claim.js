...
exports.cancelLink = exports.getLinkStatus = exports.claimERC1155 = exports.claimERC721 = exports.claim = void 0;
...
var claimERC1155 = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(_ref5) {
    var jsonRpcUrl, apiHost, weiAmount, nftAddress, tokenId, tokenAmount, expirationTime, version, chainId, linkKey, linkdropMasterAddress, linkdropSignerSignature, receiverAddress, factoryAddress, campaignId, provider, receiverSignature, linkId, claimParams, response, _response$data3, error, errors, success, txHash;

    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            jsonRpcUrl = _ref5.jsonRpcUrl, apiHost = _ref5.apiHost, weiAmount = _ref5.weiAmount, nftAddress = _ref5.nftAddress, tokenId = _ref5.tokenId, tokenAmount = _ref5.tokenAmount, expirationTime = _ref5.expirationTime, version = _ref5.version, chainId = _ref5.chainId, linkKey = _ref5.linkKey, linkdropMasterAddress = _ref5.linkdropMasterAddress, linkdropSignerSignature = _ref5.linkdropSignerSignature, receiverAddress = _ref5.receiverAddress, factoryAddress = _ref5.factoryAddress, campaignId = _ref5.campaignId;
          ...
          case 34:
            receiverSignature = _context3.sent;
            // Get linkId from linkKey
            linkId = new ethers.Wallet(linkKey, provider).address;
            claimParams = {
              weiAmount: weiAmount,
            ...
            _context3.next = 39;
            return axios.post("".concat(apiHost, "/api/v1/linkdrops/claim-erc1155"), claimParams);

          case 39:
            response = _context3.sent;
            _response$data3 = response.data, error = _response$data3.error, errors = _response$data3.errors, success = _response$data3.success, txHash = _response$data3.txHash;
  ...
  return function claimERC1155(_x3) {
...
var getLinkStatus = /*#__PURE__*/function () {
  ...
  return function getLinkStatus(_x4) {
...
var cancelLink = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            apiHost = _ref9.apiHost, linkdropMasterAddress = _ref9.linkdropMasterAddress, linkId = _ref9.linkId;
            _context5.next = 3;
  ...
  return function cancelLink(_x5) {
