...
import ERC20Mock from '../../contracts/build/ERC20Mock.json'
import ERC721Mock from '../../contracts/build/ERC721Mock.json'
...
export const approve = async ({
  ...
  const tokenContract = new ethers.Contract(tokenAddress, ERC20Mock.abi, wallet)
...
export const approveERC721 = async ({
  ...
  const nftContract = new ethers.Contract(nftAddress, ERC721Mock.abi, wallet)
