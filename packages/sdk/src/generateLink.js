...
import { createLinkERC1155 } from './utilsERC1155'
...
export const generateLinkERC1155 = async ({
  factoryAddress,
  chainId,
  claimHost,
  linkdropMasterAddress,
  ...
  const { linkKey, linkId, linkdropSignerSignature } = await createLinkERC1155(
    linkdropSigner,
    weiAmount,
    nftAddress,
    tokenId,
  ...
  // Construct link
  let url = `${claimHost}/#/receive?weiAmount=${weiAmount}&nftAddress=${nftAddress}&tokenId=${tokenId}&tokenAmount=${tokenAmount}&expirationTime=${expirationTime}&version=${version}&chainId=${chainId}&linkKey=${linkKey}&linkdropMasterAddress=${linkdropMasterAddress}&linkdropSignerSignature=${linkdropSignerSignature}&campaignId=${campaignId}`
