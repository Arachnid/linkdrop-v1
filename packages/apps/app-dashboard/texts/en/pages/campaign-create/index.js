export default {
  titles: {
    ...
    ethInLink: '{{symbol}} per link',
    tokenIdsAdded: 'Token ID added: <span>{{ids}}</span>',
    ...
    back: 'Back',
    addNFTTokenManually: 'If you don\'t see your NFT in the list — <a href="{{href}}">add token manually</a>',
    findToken: 'If you don\'t see your token in the list — <a href="{{href}}">find it manually</a>'
  },
  texts: {
